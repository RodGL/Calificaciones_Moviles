...
<?php
                        ...
                        echo '<a  href="' . $base . '/depto/nuevo"><button >Agregar</button></a>';
                        echo '</TD></TR>';
                        ...
                        foreach ($datos as $obj) {
                            ...
                            echo '</TD><TD>';
                            echo "<a href='$base/depto/consulta/" . $obj->getIddepto() .
                            "'><img src='$base/assets/images/consulta.png' alt='Consultar'/></a>";
                            echo '</TD><TD>';
                            echo "<a href='$base/depto/extrae/" . $obj->getIddepto() .
                            "'><img src='$base/assets/images/actualiza.png' alt='Modificar'/></a>";
                            echo '</TD><TD>';
                            echo '';
                            if ($obj->getStatus() == 1) {
                                echo "<a href='$base/depto/desactiva/" . $obj->getIddepto() .
                                "'><img src='$base/assets/images/desactiva.jpg' alt='Desactivar'/></a>";
                            } else {
                                echo "<a href='$base/depto/activa/" . $obj->getIddepto() .
