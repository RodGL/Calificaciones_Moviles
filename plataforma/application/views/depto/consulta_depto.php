...
foreach ($datos as $obj) {
    ...
    echo "<a href='$base/depto/index'><button type='button' class='btn btn-sm btn-danger'>Regresar</button></a>";
    echo"&nbsp;&nbsp;&nbsp;";
    echo "<a href='$base/depto/extrae/" . $obj->getIddepto() ."'><button type='button' class='btn btn-sm btn-info'>Modificar</button></a>"; 
