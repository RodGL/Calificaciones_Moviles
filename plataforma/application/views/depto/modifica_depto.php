...
foreach ($datos as $obj) {
    echo '<form action="' . $base . '/depto/modifica" method="post">
                <table>
                
                <tr>
                <td>Nombre</td>
                <td>
                <input type="text" id="iddepto" name="iddepto" value="' . $obj->getIddepto() . '" hidden="true"  />                
               ...
               <input type="submit" name="guardar" value="Guardar" class="btn btn-sm btn-primary"/>
                <a href="' . $base . '/depto/index"><button type="button" class="btn btn-sm btn-danger">Cancelar</button></a></form>';
}
?>
