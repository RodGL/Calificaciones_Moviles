...
foreach ($datos as $obj) {
    ...
    echo "<a href='$base/grupo/index'><button type='button' class='btn btn-sm btn-danger'>Regresar</button></a>";
    echo"&nbsp;&nbsp;&nbsp;";
    echo "<a href='$base/grupo/extrae/" . $obj->getIdgrupo() ."'><button type='button' class='btn btn-sm btn-info'>Modificar</button></a>"; 
