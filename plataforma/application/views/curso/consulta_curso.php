            ...
            <div >
                ...
                <td>Descripcion:</td>
                 <td>   ' . $obj->getDescripcion() . '</td>
                    ...
                    echo "<a href='$base/curso/index'><button type='button' class='btn btn-sm btn-danger'>Regresar</button></a>";
                    echo"&nbsp;&nbsp;&nbsp;";
                    echo "<a href='$base/curso/extrae/" . $obj->getIdcurso() . "'><button type='button' class='btn btn-sm btn-info'>Modificar</button></a>";
                }
                ?>
            </div>
