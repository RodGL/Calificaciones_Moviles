    ...
    <body>
        <div class="container">
            ...
            <div ><?php
                        ...
                        echo '<a  href="' . $base . '/curso/nuevo"><button class="btn btn-lg btn-primary">Agregar</button></a>';
                        echo '</TD></TR>';
                        ...
                        foreach ($datos as $obj) {
                            ...
                            echo '</TD><TD>';
                            echo "<a href='$base/curso/consulta/" . $obj->getIdcurso() .
                            "'><img src='$base/assets/images/consulta.png' alt='Consultar'/></a>";
                            echo '</TD><TD>';
                            echo "<a href='$base/curso/extrae/" . $obj->getIdcurso() .
                            "'><img src='$base/assets/images/actualiza.png' alt='Modificar'/></a>";
                            echo '</TD><TD>';
                            echo '';
                            if ($obj->getStatus() == 1) {
                                echo "<a href='$base/curso/desactiva/" . $obj->getIdcurso() .
                                "'><img src='$base/assets/images/desactiva.jpg' alt='Desactivar'/></a>";
                            } else {
                                echo "<a href='$base/curso/activa/" . $obj->getIdcurso() .
