        ...
        <div class="container">
            <div class="header clearfix" style="background-color: #1EA3DB;">
                <nav>
                    ...
                    <ul class="nav nav-pills pull-right"><li role="presentation" class="active"><?= anchor(base_url() . 'admin', 'Inicio') ?></li>
            ...
            <div >        
                ...
                <form action='<?php echo $base ?>/curso/insert' method="post" >
                    ...
                    <a href='<?php echo $base ?>/curso/index'><button type="button" class="btn btn-sm btn-danger">Cancelar</button></a>
                </form>
