...
foreach ($datos as $obj) {
    echo '<form action="' . $base . '/curso/modifica" method="post">
                <table class="table table-bordered">
                
                <tr>
                <td>Nombre</td>
                <td>
                <input type="text" id="idcurso" name="idcurso" value="' . $obj->getIdcurso() . '" hidden="true"  />                
               ...
               <input type="submit" name="guardar" value="Guardar" class="btn btn-sm btn-primary"/>
                <a href="' . $base . '/curso/index"><button type="button" class="btn btn-sm btn-danger">Cancelar</button></a></form>';
}
?>
</div>
